...
import { APP_NAME, APP_CONFIG_NAME, APP_IGNORE_NAME } from "./values";
...
const globalConfigPath = path.join(os.homedir(), APP_CONFIG_NAME);
const localConfigPath = path.join(loonygitPath, APP_CONFIG_NAME);
